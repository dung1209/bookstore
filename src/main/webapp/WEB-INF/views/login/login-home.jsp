...
<body>
    ...
    <button onclick="window.location.href = '/bookstorePTIT';"  class="btn btn-secondary back-btn">
    ...
    <div class="row">
        <div class="col-sm-4 col-sm-offset-4">
            <div class="login-form">
                ...
                <form action="/bookstorePTIT/login" method="post" modelAttribute="account">
                    <input type="text" placeholder="Tên đăng nhập" name="username" required="required" 
                    ...
                    <input type="password" placeholder="Mật khẩu" name="password" required="required" 
						oninvalid="this.setCustomValidity('Không được để trống')"
						oninput="setCustomValidity('')" />
                                    <a href="/bookstorePTIT/forgot-password" class="forgot-password ">Quên mật khẩu?</a>
                    
                    <button type="submit" class="btn btn-default">Đăng nhập</button>
                </form>
                <br>
                <!-- Nút Đăng ký -->
                <a href="/bookstorePTIT/signUp" class="register-link">Đăng ký</a>
            </div>
        </div>
    </div>
</div>
