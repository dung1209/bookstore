...
<body>
    ...
    <button onclick="window.location.href = '/bookstorePTIT/login';"  class="btn btn-secondary back-btn">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <div class="login-form">
                    <h2>Đăng ký tài khoản</h2>
						...
						<script>
						    Swal.fire({
						        ...
						        window.location.href = '<%=request.getContextPath()%>/login'; // Chuyển hướng đến trang đăng nhập
						    });
						</script>


					    </c:if>
                    <form action="/bookstorePTIT/signUp" method="post">
                    ...
                    <a href="/bookstorePTIT/login" class="register-link">Đã có tài khoản? Đăng nhập</a>
                </div>
            </div>
        </div>
    </div>
