...
<link rel="stylesheet" type="text/css"
	...
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/assets/user/css/login.css">
...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="http://localhost:8080/bookstorePTIT/"><img src="assets/user/images/home/logo.png" alt="" /></a>
						</div>
					</div>
 ...
 <div class="container">
    <button onclick="confirmBackToLogin()" class="btn btn-secondary back-btn">
    ...
    <div class="row">
        <div class="col-sm-4 col-sm-offset-4">
            <div id="formContainer">
                ...
                <!-- Form Nhập Mật Khẩu Mới (Ẩn ban đầu) -->
                <div class="login-form" id="newPasswordForm" ">
                    ...
                    <form action="${pageContext.request.contextPath}/update-password" method="post">
                        ...
                        <input type="password" placeholder="Xác nhận mật khẩu mới" name="confirmPassword" required />
...
<script>
function confirmBackToLogin() {
	Swal.fire({
        title: 'Bạn có chắc chắn?',
        text: "Bạn có muốn quay về trang đăng nhập và hủy quá trình đổi mật khẩu?",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = '/bookstorePTIT/login';
        }
