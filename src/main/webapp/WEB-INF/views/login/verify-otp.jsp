...
<body>
 ...
 <div class="container">
    <button onclick="window.location.href = '/bookstorePTIT/forgot-password';" class="btn btn-secondary back-btn">
    ...
    <div class="row">
        <div class="col-sm-4 col-sm-offset-4">
            <div id="formContainer">
                ...
                <!-- Form Nhập Mã OTP (Ẩn ban đầu) -->
                <div class="login-form" id="otpForm" >
                    <h2>Nhập Mã OTP</h2>
                    <form id="otpVerificationForm" action="${pageContext.request.contextPath}/verify-otp" method="post">
